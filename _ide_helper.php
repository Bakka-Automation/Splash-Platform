 ...
 * Generated for Laravel 5.5.33 on 2018-06-14.
 *
...
namespace Dirape\Token\Facades { 
    ...
    class Facade {
         ...
         * @static 
         */ 
        public static function Unique($table, $col, $size, $special = false)
        {
            return \Dirape\Token\Token::Unique($table, $col, $size, $special);
        }
         ...
         * @static 
         */ 
        public static function UniqueNumber($table, $col, $size, $special = false)
        {
            return \Dirape\Token\Token::UniqueNumber($table, $col, $size, $special);
        }
         ...
         * @static 
         */ 
        public static function UniqueString($table, $col, $size, $special = false)
        {
            return \Dirape\Token\Token::UniqueString($table, $col, $size, $special);
        }
         ...
         * @static 
         */ 
        public static function Random($size, $special = false)
        {
            return \Dirape\Token\Token::Random($size, $special);
        }
         ...
         * @static 
         */ 
        public static function RandomNumber($size, $special = false)
        {
            return \Dirape\Token\Token::RandomNumber($size, $special);
        }
         ...
         * @static 
         */ 
        public static function RandomString($size, $special = false)
        {
            return \Dirape\Token\Token::RandomString($size, $special);
        }
...
namespace Sukohi\CsvValidator\Facades { 
    ...
    class CsvValidator {
         ...
         * @static 
         */ 
        public static function make($path, $rules, $encoding = 'UTF-8')
        {
            return \Sukohi\CsvValidator\CsvValidator::make($path, $rules, $encoding);
        }
        ...
        {
            return \Sukohi\CsvValidator\CsvValidator::fails();
        }
        ...
        {
            return \Sukohi\CsvValidator\CsvValidator::getErrors();
        }
        ...
        {
            return \Sukohi\CsvValidator\CsvValidator::data();
        }
...
namespace  { 
    ...
    class CsvValidator extends \Sukohi\CsvValidator\Facades\CsvValidator {}
